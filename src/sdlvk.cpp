...
//---------------Functions---------------
	...
	// Create Vulkan Instance, Enable Validation Layers, Check For Req Extensions,
	void createInstance()
	{
	...
	// Setup Validation Layer and Debug Messenger
	...
	// Enumerate Devices and Pick First Suitable
	...
	// Create a Logical Device and Find Queue Families
	...
	// Create Swap Chain and Get Swap Chain Images
	...
	void createGraphicsPipeline()
	{
		...
		auto fragShaderCode = readFile("shaders/PixelShader.spv");
